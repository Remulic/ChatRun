<template>
	<view class="contents animate__animated animate__fadeIn animate__faster">
		...
		<view class="top-bar">
			...
			<!-- <view @click="backOnePage"  class="top-bar-right">
				<view class="search">
					<view class="text">
						取消
					</view>
		...
		<view class="logo">
			<view class="moni-img-logo">
				<view style="display: inline-block;" 
							class="animate__animated animate__bounceInDown">i</view>
				<view style="display: inline-block;"
					  class="animate__animated animate__bounceInLeft">
					  <i class="iconfont icon-paobu logo"></i>
					  </view>
			</view>
		</view>
		<!-- 表单 -->
		<view class="main">
			<view class="title"><span>注册中心</span></view>
			<view class="inputs">
				
				<view class="inputs-div">
					<input @blur="matchUser" class="user" type="text" v-model="user" placeholder="用户名" placeholder-style="color: #aaa; font-weight:400;"/>
					<view v-if="employ" class="employ">用户已存在</view>
					<i v-if="isuser" class="iconfont icon-profile ok"></i>
				</view>
				
				<view class="inputs-div">
					<input @blur="isEmail" class="email" type="text" v-model="email" placeholder="邮箱" placeholder-style="color: #aaa; font-weight:400;"/>
