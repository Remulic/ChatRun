...
//运动数据表
const RunDateSchema = new Schema({
  userID: { type: Schema.Types.ObjectId, ref: 'User' },
...
module.exports = db.model('RunDate', RunDateSchema, 'rundates')
module.exports = db.model('Dynamic', DynamicSchema, 'dynamics')
module.exports = db.model('Discuss', DiscussSchema, 'discuss')
module.exports = db.model('Manger', MangerSchema, 'manger')
